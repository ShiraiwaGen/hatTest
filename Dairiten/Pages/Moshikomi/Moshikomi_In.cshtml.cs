...
namespace Dairiten.Pages
{
    public class Moshikomi_InModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            public string ji_k_kodate { get; set; }                //Ž–‹Æ—pŒ_–ñŽÒ_ŒËŒš‚Ä
            public string ji_h_kodate { get; set; }                //Ž–‹Æ—p–Ú“I’n_ŒËŒš‚Ä
            public string ji_tetsuzukiiraishohakko_kbn { get; set; }   //Ž–‹Æ—pŽè‘±ˆË—Š‘”­s‹æ•ª
        }
