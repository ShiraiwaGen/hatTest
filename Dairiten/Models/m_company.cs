...
namespace Dairiten.Models
{
    ...
    public class m_company
    {
        ...
        public string insurance_name { get; set; } = null!;

        [DisplayName("事務所名")]
        [Required]
        [StringLength(50, ErrorMessage = "事務所名は５０文字以内でお願いします")]
        public string Office_name { get; set; } = null!;

        [DisplayName("事務所電話番号")]
        [Required]
        [Phone]
        [StringLength(50, ErrorMessage = "事務所電話番号は５０文字以内でお願いします")]
        public string Office_tel { get; set; } = null!;
        ...
        public string Office_day { get; set; } = null!;
        ...
        public string? bank_shiten { get; set; } = null!;

        [DisplayName("口座種目")]
        [StringLength(10, ErrorMessage = "口座種目は1０文字以内でお願いします")]
        public string? bank_account_type { get; set; } = null!;

        [DisplayName("通帳記号")]
        [StringLength(50, ErrorMessage = "通帳記号は5０文字以内でお願いします")]
        public string? passbook_symbol { get; set; } = null!;

        [DisplayName("口座番号")]
        [StringLength(10, ErrorMessage = "口座番号は1０文字以内でお願いします")]
        public string? bank_account_no { get; set; } = null!;

        [DisplayName("口座名義人")]
        [StringLength(50, ErrorMessage = "口座名義人は5０文字以内でお願いします")]
        public string? bank_account_holder { get; set; } = null!;

        [DisplayName("口座名義人カナ")]
        [StringLength(50, ErrorMessage = "口座名義人カナは5０文字以内でお願いします")]
        public string? bank_account_holder_kana { get; set; } = null!;
    }
}
